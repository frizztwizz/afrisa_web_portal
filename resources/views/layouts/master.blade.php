                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="/about">data saya <span class="sr-only">(current)</span></a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link bg-primary" href="/register"> <span class="text-white">Daftar</span> <span class="sr-only"> (current)</span></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 py-4 Reserved">
                    ...
                    Copyright 2024, All rights reserved. Design by <a href="#" title="Free HTML5 Bootstrap templates">Afrisa</a>.
